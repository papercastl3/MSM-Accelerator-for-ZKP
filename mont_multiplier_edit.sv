...
module mont_multiplier (
    ...
    assign valid_write_1_forBank01 = dsp_active[1] && (w_addr_reg_1_forBank01 <= 5'd16) && dsp1_valid;
    assign valid_write_1_forBank23 = dsp_active[1] && (w_addr_reg_1_forBank23 <= 5'd16) && dsp1_valid;
    ...
    always_ff @(posedge clk) begin
        if (state_mem == S_INIT) begin 
            ...
            else if   (valid_write_1_forBank01 && w_addr_reg_1_forBank01[1:0] == 2'b00) t_bank_0[ w_addr_reg_1_forBank01[4:2] ] <= dsp_p[1][W-1:0];
            ...
            else if   (valid_write_1_forBank01 && w_addr_reg_1_forBank01[1:0] == 2'b01) t_bank_1[ w_addr_reg_1_forBank01[4:2] ] <= dsp_p[1][W-1:0];
            ...
            else if   (valid_write_1_forBank23 && w_addr_reg_1_forBank23[1:0] == 2'b10) t_bank_2[ w_addr_reg_1_forBank23[4:2] ] <= dsp_p[1][W-1:0];
            ...
            else if   (valid_write_1_forBank23 && w_addr_reg_1_forBank23[1:0] == 2'b11) t_bank_3[ w_addr_reg_1_forBank23[4:2] ] <= dsp_p[1][W-1:0];
